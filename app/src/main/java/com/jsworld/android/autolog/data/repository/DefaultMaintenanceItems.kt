...
object DefaultMaintenanceItems {
    ...
    val items = listOf(
        ...
        // 🧼 기타 소모품/관리 — 주기를 두지 않는다(기록 전용).
        // 한 달 세차를 안 했다고 빨간 "초과" 경고를 띄우면 진짜 정비 경고가 묻힌다.
        // 주기 알림을 원하는 사용자는 항목 상세에서 직접 주기를 설정하면 된다.
        "실내/외 세차(관리)" to Pair(null, null),
        "코팅/왁스(관리)" to Pair(null, null),
